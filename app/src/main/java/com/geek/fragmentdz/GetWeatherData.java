...
public class GetWeatherData {
    private static final String WEATHER_URL = "api.openweathermap.org/data/2.5/weather?q=%s&units=metric&appid=%s";
                ...
                public void run() {
                    ...
                    try {
                        ...
                        handler.post(new Runnable() {
                            @Override
                            public void run() {
                                setWeatherData(weatherDataController);
                            }
                        });
    ...
    private void setWeatherData(WeatherDataController weatherDataController) {
        temp = weatherDataController.getMain().getTemp();
        cityName = weatherDataController.getName();
        System.out.println(weatherDataController.getMain().getTemp());
    }
